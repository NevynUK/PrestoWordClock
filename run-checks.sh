...
SOURCE_DIR=$scriptdir/src

echo "Running cppcheck"

cppcheck --error-exitcode=1 --quiet --check-level=exhaustive --force --inline-suppr -iCMakeLists.txt -ibuild $SOURCE_DIR

echo "Running clang-format"
clang-format --dry-run --Werror $VERBOSE_FLAGS $SOURCE_DIR/*.?pp
